...
home = os.getcwd()
record_dir = os.path.join(home, 'record-new/balance')
...
flags.DEFINE_integer('class_num', 5, 'the class number')
...
flags.DEFINE_integer('iter_num', int(2000), 'iteration number')
